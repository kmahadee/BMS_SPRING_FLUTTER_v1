...
class ApiConstantsExtension {
  ...
  static const String _accountsByCustomerTemplate = '/api$accountsBase/customer/{customerId}';
  
  /// Get account by account number
  /// GET /api/accounts/account-number/{accountNumber}
  static const String _accountByNumberTemplate = '/api$accountsBase/account-number/{accountNumber}';
  
  /// Get account balance by account number
  /// GET /api/accounts/{accountNumber}/balance
  static const String _accountBalanceTemplate = '/api$accountsBase/{accountNumber}/balance';
  ...
  static const String _freezeAccountTemplate = '/api$accountsBase/{accountNumber}/freeze';
  
  /// Unfreeze account
  /// PUT /api/accounts/{accountNumber}/unfreeze
  static const String _unfreezeAccountTemplate = '/api$accountsBase/{accountNumber}/unfreeze';
  
  /// Get accounts by status
  /// GET /api/accounts/status/{status}
  static const String _accountsByStatusTemplate = '/api$accountsBase/status/{status}';
  ...
  static const String _branchStatisticsTemplate = '/api$branchesBase/{id}/statistics';
  ...
  static const String _branchByIfscTemplate = '/api$branchesBase/ifsc/{ifscCode}';
  
  /// Get branch by branch code
  /// GET /api/branches/code/{branchCode}
  static const String _branchByCodeTemplate = '/api$branchesBase/code/{branchCode}';
  
  /// Get branches by status
  /// GET /api/branches/status/{status}
  static const String _branchesByStatusTemplate = '/api$branchesBase/status/{status}';
  ...
  static String getAccountByNumber(String accountNumber) {
    return _accountByNumberTemplate.replaceAll('{accountNumber}', accountNumber);
  }
  ...
  static String getUnfreezeAccount(String accountNumber) {
    return _unfreezeAccountTemplate.replaceAll('{accountNumber}', accountNumber);
  }
...
extension ApiConstantsAccountExtension on Type {
  ...
  String accountsByCustomer(int customerId) => ApiConstantsExtension.getAccountsByCustomer(customerId);
  String accountByNumber(String accountNumber) => ApiConstantsExtension.getAccountByNumber(accountNumber);
  String accountBalance(String accountNumber) => ApiConstantsExtension.getAccountBalance(accountNumber);
  String get accountStatement => ApiConstantsExtension.accountStatement;
  String freezeAccount(String accountNumber) => ApiConstantsExtension.getFreezeAccount(accountNumber);
  String unfreezeAccount(String accountNumber) => ApiConstantsExtension.getUnfreezeAccount(accountNumber);
  String accountsByStatus(String status) => ApiConstantsExtension.getAccountsByStatus(status);
  ...
  String branchStatistics(int branchId) => ApiConstantsExtension.getBranchStatistics(branchId);
  String branchesByCity(String city) => ApiConstantsExtension.getBranchesByCity(city);
  String branchByIfsc(String ifscCode) => ApiConstantsExtension.getBranchByIfsc(ifscCode);
  String branchByCode(String branchCode) => ApiConstantsExtension.getBranchByCode(branchCode);
  String branchesByStatus(String status) => ApiConstantsExtension.getBranchesByStatus(status);
