...
class AppRoutes {
  ...
  static const Set<String> _publicRoutes = {
    splash, onboarding, login, signup, forgotPassword, resetPassword,
    help, faq, termsAndConditions, privacyPolicy,
  };

  static bool isHomeRoute(String route) => _homeRoutes.contains(route);

  static const Set<String> _homeRoutes = {
    home, customerHome, employeeHome, adminHome, superAdminHome,
    branchManagerHome, loanOfficerHome, cardOfficerHome,
  };
