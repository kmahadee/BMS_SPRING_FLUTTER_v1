class TransactionDTO {
  ...
  factory TransactionDTO.fromJson(Map<String, dynamic> json) {
    return TransactionDTO(
      id: (json['transactionId'] ?? json['id'])?.toString(),
      transactionReference:
          (json['referenceNumber'] ?? json['transactionReference']) as String?,
      transactionType: json['transactionType'] as String,
      amount: (json['amount'] ?? 0).toDouble(),
      fromAccount: (json['accountNumber'] ?? json['fromAccount']) as String?,
      toAccount:
          (json['otherAccountNumber'] ?? json['toAccount']) as String?,
      transactionDate: DateTime.parse(
        (json['timestamp'] ?? json['transactionDate']) as String,
      ),
      ...
      channel: (json['transferMode'] ?? json['channel']) as String?,
    );
  }
...
//       transactionReference: json['referenceNumber'] as String?,
//       transactionType: json['transactionType'] as String,
//       amount: (json['amount'] ?? 0).toDouble(),
//       fromAccount: json['accountNumber'] as String?,
//       toAccount: json['otherAccountNumber'] as String?,
//       transactionDate: DateTime.parse(json['timestamp'] as String),
//       description: json['description'] as String?,
//       balanceAfter: json['balanceAfter'] != null
//           ? (json['balanceAfter'] as num).toDouble()
//           : null,
//       status: json['status'] as String?,
//       channel: json['transferMode'] as String?,
//     );
//   }
