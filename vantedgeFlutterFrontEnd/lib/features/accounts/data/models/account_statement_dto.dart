...
class AccountStatementDTO {
  ...
  factory AccountStatementDTO.fromJson(Map<String, dynamic> json) {
    return AccountStatementDTO(
      ...
      fromDate: DateTime.parse(
        (json['statementStartDate'] ?? json['fromDate']) as String,
      ),
      toDate: DateTime.parse(
        (json['statementEndDate'] ?? json['toDate']) as String,
      ),
      ...
      transactions: (json['transactions'] as List<dynamic>?)
          ...
          [],
      accountHolderName:
          (json['customerName'] ?? json['accountHolderName']) as String?,
  ...
  double get totalCredits =>
      transactions.where((t) => t.isCredit).fold(0.0, (sum, t) => sum + t.amount);

  double get totalDebits =>
      transactions.where((t) => t.isDebit).fold(0.0, (sum, t) => sum + t.amount);

  int get creditTransactionCount =>
      transactions.where((t) => t.isCredit).length;
  ...
  @override
  String toString() =>
      'AccountStatementDTO(account: $accountNumber, period: ${fromDate.toIso8601String()} to ${toDate.toIso8601String()}, transactions: ${transactions.length})';
}
